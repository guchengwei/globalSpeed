...
export class ConfigSync {
  ...
  client = new SubscribeView({ghostMode: true, ghostModeUrlCondition: true, enabled: true, superDisable: true, latestViaShortcut: true, keybinds: true, keybindsUrlCondition: true, indicatorInit: true, circleWidget: true, circleInit: true, holdToSpeed: true, enforceNormalSpeedOnYoutubeLive: true}, gvar.tabInfo.tabId, true, (v, onLaunch) => {
  ...
  handleChange = () => {
    ...
    if (gvar.os.mediaTower) {
      gvar.os.mediaTower.enforceNormalSpeedOnYoutubeLive = view.enforceNormalSpeedOnYoutubeLive !== false
    }
