...
import { KosCorpusCandidates, KosPresetEditor } from "./KosPresetEditor"
	...
	return (
		<OptionsSection>
			...
			<div className="mt-5">
				...
				{/* Keyword candidates mined from the Manual Mark corpus (#26) */}
				<KosCorpusCandidates view={view} setView={setView} />
